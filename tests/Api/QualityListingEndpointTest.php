...
class QualityListingEndpointTest extends WebTestCase
{
    ...
    public function testEndpointNoScoresCalculated()
    {
        ...
        try {
            HttpClient::create()->request('GET', 'http://localhost:8080/api/v1/quality-ads');
     ...
     * @throws ClientExceptionInterface
     */
    public function testEndpointNoQualityAdsAre()
    {
        $expectedStatusCode = 404;
        $expectedBodyMessage = 'No quality ads in system';
     ...
     * @throws ClientExceptionInterface
     */
    public function testEndpointGetQualityAds()
    {
